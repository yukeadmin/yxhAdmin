      			  ...
      			  "columnDefs": [//设置列定义初始化属性
      			            {
      			            	"targets": [4],
      			            	"render" : function(data,type,row, meta) {
      			            		var str='<a title="删除" href="javascript:;" class="ml-5" onclick="statusVideo(\''+row.b_num+'\',\'5\')" style="text-decoration:none"><i class="Hui-iconfont">&#xe609;</i></a>';
    			            		if(row.b_state=='1'){
    			            			str+='<a title="下架" class="ml-5"  onclick="statusBook(\''+row.b_num+'\',\'0\')" style="text-decoration:none">下架</a>';
    			            		}else{
    			            			str+='<a title="发布" class="ml-5"  onclick="statusBook(\''+row.b_num+'\',\'1\')" style="text-decoration:none">发布</a>';
    			            		}
    			            		return str;
