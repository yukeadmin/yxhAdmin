		...
		<article class="Hui-admin-content clearfix">
			<div class="panel mt-20">
                <div class="panel-body">
                    <div class="clearfix">
                            <span class="f-l">
                                <a href="javascript:;" onclick="admin_add('添加用户','admin-add.jsp','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加管理员</a>
                            </span>
                    </div>
	      			  ...
	      			  "columnDefs": [//设置列定义初始化属性
	      			            {
	      			            	"targets": [10],
	      			            	"render" : function(data,type,row, meta) {
	      			            		var str='<a title="编辑" href="javascript:;" class="ml-5" onclick="editUser(\''+row.a_num+'\',\'a\')"  style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>';
	      			            		str+='<a title="重置密码" href="javascript:;" class="ml-5" onclick="resetpwd(\''+row.a_num+'\',\'a\')" style="text-decoration:none"><i class="Hui-iconfont">&#xe63f;</i></a>';
	    			            		if(row.a_state=='0'){
	    			            			str+='<a title="启用" href="javascript:;" class="ml-5" onclick="statusUser(\''+row.a_num+'\',\'a\',\'1\')"  style="text-decoration:none"><i class="Hui-iconfont">&#xe6e1;</i></a>';
	    			            		}else if(row.a_state=='1'){
	    			            			str+='<a title="停用" class="ml-5"  onclick="statusUser(\''+row.a_num+'\',\'a\',\'0\')" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>';
	    			            		}
	    			            		return str;
