    ...
    <article class="Hui-admin-content clearfix">
        <div class="panel">
            <div class="panel-body">
                <form action="user/courseAdd.action" method="post" class="form form-horizontal" id="form-course-add" enctype="multipart/form-data">
                    ...
                    <div class="row clearfix">
                     ...
                     <div class="row clearfix">
                         <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>课程教师：</label>
                         <div class="form-controls col-xs-2 col-sm-2">
						 <span class="select-box" style="width: 50%">
						 <select name="courseteacher" class="select" title="请选择课程教师!" required>
							 <option value=""></option>
							 <c:forEach items="${AllTeacherCount }" var="bean">
								 <option value="${bean.t_num }">${bean.t_name }</option>
							 </c:forEach>
						 </select>
						 </span>
                         </div>
                    ...
                    <div class="row clearfix">
						...
						<span class="btn-upload">
							<!-- <a href="javascript" class="btn btn-primary radius btn-upload"><i class="Hui-iconfont">&#xe642;</i> 浏览文件</a><input type="file" name="file" id="btn-upload-file-thumb" class="input-file"> -->
