/* -----------H-ui前端框架-------------
* h-ui.admin.pro.js v1.0.3
* http://www.h-ui.net/
* Created & Modified by guojunhui
* Date modified 2018.12.14
...
$(function(){
	...
	/*选项卡导航*/
	$(".Hui-admin-aside-wrapper").on("click",".Hui-menu .Hui-menu-title a,.Hui-menu .Hui-menu-item a",function(){
		Hui_admin_tab(this);
		$(".Hui-admin-aside-wrapper").find(".Hui-menu .Hui-menu-title,.Hui-menu .Hui-menu-item ul li").removeClass("current");
