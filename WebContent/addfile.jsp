...
<div class="wap-container">
		<div class="panel">
			<div class="panel-body">
				<form action="user/editCourseImg.action" method="post" class="form form-horizontal" id="form-course-update" enctype="multipart/form-data">
                    <div class="row clearfix">
                        <label class="form-label col-xs-5 col-sm-3"><span class="c-red">*</span>课程封面：</label>
